...
public class StemCrop extends TemplatePlantBlock
{
    private final Block baseBlock;

    public StemCrop(Identifier identifier, Block block)
    {
        super(identifier, 0);
    ...
    {
        return meta >= 0 ? Pocket.TEXTURE_STEM : Pocket.TEXTURE_STEM_CONNECTED;
    }
    ...
    public void dropStacks(World world, int x, int y, int z, int meta, float luck)
    {
        ...
        Item item = null;
//      if (this.baseBlock == Block.PUMPKIN)
//          item = Item.pumpkinSeeds;
        if (this.baseBlock == Pocket.BLOCK_MELON)
